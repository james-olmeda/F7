...
public struct OpenF1CarData: Codable, Hashable, Identifiable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.rpm = try container.decodeIfPresent(Int.self, forKey: .rpm) ?? 0
        self.speed = try container.decodeIfPresent(Int.self, forKey: .speed) ?? 0
        self.gear = try container.decodeIfPresent(Int.self, forKey: .gear) ?? 0
        ...
        self.drs = try container.decodeIfPresent(Int.self, forKey: .drs) ?? 0
